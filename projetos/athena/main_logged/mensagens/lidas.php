			...
			if(@pg_num_rows($data) < 1)
			{
				?>
					<tr>
						<td class="gridCell"
							colspan="5">
							N&atilde;o h&aacute; mensagens lidas
						</td>
					</tr>
				<?php
			}else{
					while($linha= @pg_fetch_array($data))
					{
						?>
							<tr style=""
								...
								ondblclick="creatBlock('<?php echo htmlentities($linha['s_titulo']); ?>', 'mensagens/lidas.php?msgToRead=<?php echo $linha['pk_mensagem_usuario']; ?>', 'LendoMsg_<?php echo $linha['pk_mensagem_usuario']; ?>', false, false, '400/300');">
								<td class="gridCell"
								...
								<td class="gridCell"
									...
									<img src="img/icon_view.gif"
										 ...
										 onclick="creatBlock('<?php echo htmlentities($linha['s_titulo']); ?>', 'mensagens/lidas.php?msgToRead=<?php echo $linha['pk_mensagem_usuario']; ?>', 'LendoMsg_<?php echo $linha['pk_mensagem_usuario']; ?>', false, false, '400/300');">
								</td>
								<td class="gridCell"
									style="width: 25px;">
									<img src="img/file_delete.gif"
