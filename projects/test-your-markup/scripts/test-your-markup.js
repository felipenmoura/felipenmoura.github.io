!function(scope, undefined){
	...
	var lists= {
        ...
        'js-libs': ["chr.js","dojo toolkit","jquery","midori","mootools","react","anychart","d3.js","highcharts","p5.js","pixi.js","plotly","raphaël","swfobject","velocity.js","whitestormjs","bootstrap","dhtmlx","jqwidgets","qooxdoo","smartclient","webix","winjs","gijgo","glow","script.aculo.us","joose","jsphp","mochikit","pdf.js","rico","jquery mobile","mustache","jasmine","mocha","qunit","tape","angularjs","aurelia","cappuccino","echo","ember.js","enyo","ext js","javascriptmvc","knockout","meteor","mojito","node.js","sproutcore","modernizr","wakanda","ajax","prototype","easeljs","infovis","processing","processingjs","processing.js","three","threejs","three.js","angular","devextreme","dojo","extjs","ext.js","zurb","polymer","jquery ui","jqueryui","ignite","igniteui","kendo","kendoui","wijmo","openui5","ample","lively","yui","spry","socketio","socket.io","underscore","underscore.js","cascade","jinja","twig","jsunit","unit","backbone","chaplin","vue","cassowary","rialto"]
	}
